...
const question = function () {
  if (i < 7) {
    ...
    setTimeout(
      () =>
        console.log(`
    	${ansObj[0]} is good person through this survey we can say it that he likes to do ${ansObj[1]} 
    	while listening to ${ansObj[2]}.
    	Mostly likes to eat ${ansObj[4]} for their favorite meal ${ansObj[3]}, and one more thing 
    	${ansObj[0]}'s absolute favorite sport is ${ansObj[5]}.
    	When ${ansObj[0]} was asked about their superpower they answered: ${ansObj[6]}
  	`),
      1500
    );
  }
